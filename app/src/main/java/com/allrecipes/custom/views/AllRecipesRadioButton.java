...
public class AllRecipesRadioButton extends AppCompatRadioButton {

    public AllRecipesRadioButton(Context context) {
        this(context, null);
    }

    public AllRecipesRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public AllRecipesRadioButton(Context context, AttributeSet attrs, int defStyle) {
